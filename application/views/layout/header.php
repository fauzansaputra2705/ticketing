	...
	<div id="app" class="">
		<div class="main-wrapper ">
			<nav class="navbar navbar-expand-lg " style="position: fixed; width: 100%;">
				<a href="<?php echo site_url('User') ?>" class="navbar-brand">Ticketing</a>
					...
					<div class="search-element">
						...
						<div class="search-result">
							...
							<div class="search-item">
								<a href="#">
									<img class="mr-3 rounded" width="30"
										src="<?php echo base_url() ?>assets/img/products/product-3-50.png" alt="product">
							...
							<div class="search-item">
								<a href="#">
									<img class="mr-3 rounded" width="30"
										src="<?php echo base_url() ?>assets/img/products/product-2-50.png" alt="product">
									Drone X2 New Gen-7
								</a>
							</div>
							<div class="search-item">
								<a href="#">
									<img class="mr-3 rounded" width="30"
										src="<?php echo base_url() ?>assets/img/products/product-1-50.png" alt="product">
									Headphone Blitz
								</a>
							</div>
							<div class="search-header">
				...
				<?php } ?>
					<?php if ($this->session->userdata('role_id') != '2') { ?>
						<li>
							<a href="<?php echo site_url('Welcome/login') ?>" class="btn btn-light">Login</a>
						</li>
					<?php }else{ ?>
