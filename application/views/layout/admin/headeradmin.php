...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.4.1/css/flag-icon.css">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="<?php echo site_url('Welcome/logout') ?>" class="dropdown-item has-icon text-danger">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo site_url('Admin/index') ?>">Admin ticketing</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?php echo site_url('Admin/index') ?>">TK</a>
          </div>
          <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown active">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo site_url('Admin/penumpang') ?>"><i class="fas fa-user"></i> <span>Data User</span></a></li>
                <li><a class="nav-link" href="<?php echo site_url('Admin/petugas') ?>"><i class="fas fa-user-tie"></i> <span>Data Petugas</span></a></li>
                <li><a class="nav-link" href="<?php echo site_url('Admin/transportasi') ?>"><i class="fas fa-bus"></i> <span>Data Transportasi</span></a></li>
                <li><a class="nav-link" href="<?php echo site_url('Admin/rute') ?>"><i class="fas fa-route"></i> <span>Data Rute</span></a></li>
              </ul>
            </li>
            <li><a class="nav-link" href="blank.html"><i class="fas fa-ticket-alt"></i> <span>Data Booking</span></a></li>
            <li class="menu-header">Laporan</li>
            <li class="nav-item dropdown active">
              <a href="#" class="nav-link has-dropdown"><i class="far fa-file"></i></i><span>Laporan</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="blank.html"><i class="fas fa-calendar-alt"></i> <span>Laporan Jadwal</span></a></li>
                <li><a class="nav-link" href="blank.html"><i class="fas fa-calendar-alt"></i></i> <span>Laporan Booking</span></a></li>
              </ul>
            </li>
            ...
            <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
              <a href="<?php echo site_url('User') ?>" class="btn btn-primary btn-lg btn-block btn-icon-split">
                <i class="fas fa-eye"></i></i>Lihat Website
              </a>
            </div>
          </aside>
        </div>
